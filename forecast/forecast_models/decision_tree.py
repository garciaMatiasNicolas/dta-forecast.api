...
def decision_tree_regression_predictions(fila, error_periods, test_periods, prediction_periods, seasonal_periods, error_method):
    try:
        ...
        error = Error(dataframe=df_pred_pivot, model_name='decisionTree', error_method=error_method, error_periods=error_periods)
